...
```gradle
    compile 'com.github.ReflxctionDev:Regenerato:1.4-SNAPSHOT'
```

# Download
Download latest version [here](https://github.com/ReflxctionDev/Regenerato/releases/tag/1.4-SNAPSHOT).
