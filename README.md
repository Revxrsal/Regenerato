...
```gradle
    compile 'com.github.ReflxctionDev:Regenerato:1.3.1-SNAPSHOT'
```

# Download
Download latest version [here](https://github.com/ReflxctionDev/Regenerato/releases/tag/1.3.1-SNAPSHOT).
